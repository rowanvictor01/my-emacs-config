...
;;; Commentary:
;;; soft-charcoal theme created by  in 2026
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:box (:line-width 1 :color nil) :bold t :foreground ,var :background ,bg2))))
   `(mode-line-inactive ((,class (:box (:line-width 1 :color nil :style pressed-button) :foreground ,fg4 :background ,bg1 :weight normal))))
